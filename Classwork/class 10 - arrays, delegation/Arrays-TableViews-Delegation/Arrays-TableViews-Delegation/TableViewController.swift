...
class TableViewController: UITableViewController, ToDoList {
    ...
    func addTaskToArray(newTask: String) {
        self.myToDoList.append(newTask)
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        // Sets each cell to equal each item in the array
                    ...
                    //this will make every other row gray
        
                    cell.textLabel?.text = self.myToDoList[indexPath.row]
                    return cell
        // this will return each item in array into a row in the sequence of the array
    ...
    override func tableView(tableView: UITableView, commitEditingStyle editingStyle: UITableViewCellEditingStyle, forRowAtIndexPath indexPath: NSIndexPath) {
        if editingStyle == .Delete {
            self.myToDoList.removeAtIndex(indexPath.row)
